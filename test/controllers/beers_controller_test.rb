...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference("Beer.count") do
      post beers_url, params: { beer: { brand: @beer.brand, country: @beer.country, quanity: @beer.quanity, style: @beer.style } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { brand: @beer.brand, country: @beer.country, quanity: @beer.quanity, style: @beer.style } }
